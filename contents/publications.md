<table>
  <tr>
    ...
    <!-- 右边放论文介绍 -->
    <td width="60%">
      <h3>[Enhance Multi-View Classification through Multi-Scale Alignment and Expanded Boundary](https://openreview.net/pdf?id=t1J2CnDFwj)</h3>
      <p>
...
<table>
  <tr>
    ...
    <!-- 右边放论文介绍 -->
    <td width="60%">
      <h3>[Fuzzy Neural Network for Representation Learning on Uncertain Graphs](https://ieeexplore.ieee.org/abstract/document/10571582/)</h3>
      <p>
...
<table>
  <tr>
    ...
    <!-- 右边放论文介绍 -->
    <td width="60%">
      <h3>[Fuzzy Representation Learning on Graphs](https://ieeexplore.ieee.org/abstract/document/10061283/)</h3>
      <p>
...
<table>
  <tr>
    ...
    <!-- 右边放论文介绍 -->
    <td width="60%">
      <h3>[Multiple Views to Free Graph Augmentations](https://ieeexplore.ieee.org/abstract/document/10342655/)</h3>
      <p>
        C. Zhang, <strong>Y. Lin</strong>, C. Chen, H. Yao, H. Cai, W. Fang.
